            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @if (Auth::guest())
                            <li><a href="{{ url('/blog') }}"> <i class="material-icons">question_answer</i> Blog</a>
                            </li>
                            <li><a href="{{ url('/contact-us') }}"> <i class="material-icons">contact_mail</i> Contact
                                    Us</a></li>
                            <li><a href="{{ route('login') }}"> <i class="material-icons">fingerprint</i> Login</a></li>
                            <li><a href="{{ route('register') }}"><i class="material-icons">subscriptions</i>
                                    Register</a></li>
                        @else
                            <li>
                                <a href="{{ url('/blog') }}">
                            ...
                            <li><a href="{{ url('/contact-us') }}"> <i class="material-icons">contact_mail</i> Contact
                                    Us</a></li>
                            <li>
                                <a href="{{ url('/user/dashboard') }}"> <i class="material-icons">dashboard</i>
                                    Dashboard </a>
                            </li>
                            <li>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="{{route('subscriber.runsetup', Auth::user()->id)}}"> <i
                                                        class="material-icons">recent_actors</i> My Profile </a>
                                        </li>
                                        <li>
                                            <a href="{{route('subscriber.runsetup', Auth::user()->id)}}"> <i
                                                        class="material-icons">explicit</i> Edit Profile </a>
                                        </li>
                                        <li>
